...
**Note:** Item 56 (partial result streaming) addresses outbound latency
for large result sets. See also item 89 (incremental text sync) in the
backlog, which addresses the complementary inbound direction.
